...
//  {
//    ModBluetooth.print("Pies mal colocados");
//    ModBluetooth.print("#");
  ...
  if (ModBluetooth.available())
  {
    ...
    switch (VarChar) {
      case '1': //Iniciar la Posición paralela
        ...
        counter_timer = 0;
        enable_timer = 1;
        ModBluetooth.print("Midiendo tiempo en posición paralela...");
        ModBluetooth.print("#");
        break;
      ...
      case '2': //Iniciar la Posición semitandem
        ...
        counter_timer = 0;
        enable_timer = 1;
        ModBluetooth.print("Midiendo tiempo en posición semitandem...");
        ModBluetooth.print("#");
        break;
      ...
      case '3': //Iniciar la Posición tandem
        ...
        counter_timer = 0;
        enable_timer = 1;
        ModBluetooth.print("Midiendo tiempo en posición tandem...");
        ModBluetooth.print("#");
        break;
      ...
      case '5': //Mensaje de advertencia
        ...
        ModBluetooth.print("...");
        ModBluetooth.print("#");
        ModBluetooth.print("Por favor, coloque los pies en una posición correcta");
        ModBluetooth.print("#");
        break;
...
{
  ModBluetooth.print("NO Se superó el tiempo en equilibrio exitosamente");
  ModBluetooth.print("#");
}
else
{
...
void equilibrio()
{
  ...
  enable_timer = 0;
  counter_timer = 0;
  ModBluetooth.print("Se superó el tiempo en equilibrio exitosamente");
  ModBluetooth.print("#"); 
  dato_leido = 0;
